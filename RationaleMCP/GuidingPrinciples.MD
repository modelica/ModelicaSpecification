...
4. Neutrality: The Modelica Language shall be neutral with respect to tools, technologies (e.g. processors, compilers, OS, file system access, solvers, real-time capability, ...) and languages.
