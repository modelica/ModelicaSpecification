...
- [ ] Remove byte order mark, as it is already deprecated in [full Modelica](https://specification.modelica.org/master/packages.html#file-system-mapping-of-package-class).
