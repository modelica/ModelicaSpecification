...
- [ ] Get rid of conditional components.  (The _condition-attribute_ is still present in grammar.) [PR with discussion](https://github.com/modelica/ModelicaSpecification/pull/3149)
