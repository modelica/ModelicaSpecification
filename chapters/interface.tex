...
\end{itemize}
If the subexpressions satisfy the following restrictions they are called type compatible expressions, and the resulting type of the expression is the type compatible expression.
