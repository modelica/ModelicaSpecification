...
in A. If A has a declaration \lstinline!Real y!, this declaration must not be
present in B}{]}.\\ \hline
\begin{tabular}{@{}p{4cm}@{}}
...
with the \lstinline!input! prefix, because then they must be connected.}{]} A
...
parts of the name must be transitively non-replaceable, i.e. in} \lstinline!extends A.B.C! \emph{this implies that} \lstinline!A.B.C! \emph{must be transitively
non-replaceable, as well as }\lstinline!A! \emph{and }\lstinline!A.B!\emph{, with the exception of the \emph{class
