...
\begin{definition}[Plug-compatibility (= restricted subtyping)]\index{plug-compatibility}%
\index{restricted subtype|seealso{plug-compatibility}}% Can't use 'seealso' in index for some reason, using 'see' as workaround.
