...
%TODO-BACK Check: pdf and word was incoherent?
...
\lstinline[basicstyle=\ttfamily]!R(b=true, x=1.2, a=2),...)!\emph{. The statement that} \lstinline[basicstyle=\ttfamily]!r! \emph{has the type (or
interface)} \lstinline[basicstyle=\ttfamily]!R! \emph{means that the value of} \lstinline[basicstyle=\ttfamily]!r! \emph{belongs to this
infinite set}.
