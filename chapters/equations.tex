...
The \lstinline!reinit!-equation can only be used in the body of a \lstinline!when!-equation.
(There is also \lstinline!reinit! declaration equation, \cref{setting-states}.)
