...
All equations and assignment statements within \lstinline!when!-clauses all assignment statements within \lstinline!function! classes are implicitly treated with \lstinline!noEvent!, i.e., relations within the scope of these operators never induce state or time events.
Clocked discrete-time partitions also also treated this way, see \cref{clocked-discrete-time-and-clocked-discretized-continuous-time-partition}.
