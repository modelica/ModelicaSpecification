...
If \lstinline!reinit(x, expr)! is inside an \lstinline!if!-equation in the \lstinline!when!-clause it is treated as and counted as the equation \lstinline!x = expr;! for the \lstinline!if!-equations according to \cref{if-equations}.
