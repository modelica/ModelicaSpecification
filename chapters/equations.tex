...
\begin{enumerate}
\item
  As equations in an \lstinline!initial equation!\index{initial equation@\robustinline{initial equation}} section or as assignments in an \lstinline!initial algorithm!\index{initial algorithm@\robustinline{initial algorithm}} section.
