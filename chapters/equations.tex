...
\end{lstlisting}
whereas the restriction to evaluable-expression is intended to allow:
\begin{lstlisting}[language=modelica]
...
\end{lstlisting}
if \lstinline!steadyState! had not been an evaluable parameter-expression both of those equations would have been illegal according to the restrictions in \cref{if-equations}.
\end{example}
