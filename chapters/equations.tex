...
Connect-equations are described in detail in \cref{connect-equations-and-connectors}.
...
\item
  The branches of an \lstinline!if!-equation inside when-equations must have the same set of component references on the left-hand side, unless all switching conditions of the \lstinline!if!-equation are parameter expressions.
\end{itemize}
