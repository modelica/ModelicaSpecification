...
\lstinline!reinit! can for the same variable (resp.\ array of variables) only be applied (either as an individual variable or as part of an array of variables) in one equation (having \lstinline!reinit! of the same variable in \lstinline!when! and \lstinline!elsewhen! one \emph{one} \lstinline!when!-statement is allowed).
...
\section{Initialization, initial equation, and initial algorithm}\label{initializ1ation-initial-equation-and-initial-algorithm}
