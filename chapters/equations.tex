...
There are two variants of \lstinline!reinit!, the other is restricted to declaration equations, see \cref{setting-states}.
This \lstinline!reinit! can only be used in the body of a \lstinline!when!-equation.
