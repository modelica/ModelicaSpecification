...
In details this means that during initialization initial equations and normal equations are solved with \lstinline!v! and \lstinline!pre(v)! as unknowns without any event iterations.
Then \lstinline!v! is copied to \lstinline!pre(v)! and only the normal equations are solved repeatedly until \lstinline!v = pre(v)!.
