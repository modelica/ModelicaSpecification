...
An element declared with the prefix \lstinline!outer!\index{outer@\indexinline{outer}} references an element instance with the same name but using the prefix \lstinline!inner!\index{inner@\indexinline{inner}} which is nearest in the enclosing instance hierarchy of the \lstinline!outer! element declaration.
