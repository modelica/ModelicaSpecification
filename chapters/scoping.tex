...
Outer component declarations shall not have the prefix \lstinline!input! and may only use \lstinline!output! in state machines with special semantics, \cref{merging-variable-definitions}.
