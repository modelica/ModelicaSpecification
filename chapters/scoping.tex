...
\item
  ...
  If the class does not satisfy the requirements for a \lstinline!package!, the lookup is restricted to encapsulated\indexinline{encapsulated} elements only.
  The special case where the class satisfies the requirements for a \lstinline!package!, but is not declared as \lstinline!package! or \lstinline!operator!, is deprecated.
