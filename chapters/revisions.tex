...
\item Conversions were used for Modelica Standard Library 4.0.0, and were thus clarified and slightly extended for the future.
\begin{itemize}
...
\item Added and clarified other specific annotations.
\begin{itemize}
...
\item Clarified synchonous Modelica.
\begin{itemize}
...
\item Clarified quoted identifiers, \cref{xxx}.
...
Ticket \href{https://github.com/modelica/ModelicaSpecification/issues/2560}{\#2560}.
\item Restructure description of Real and Integers types to keep details together, \cref{real-type}.
