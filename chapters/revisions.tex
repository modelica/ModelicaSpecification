...
\item Only restrict public connectors in blocks, \specpull{3318}.
\item Improve iterator examples \specpull{3317}.
\item Remove \lstinline!extends FilledShape! from Text-definitions, \specpull{3316}.
\item Clarified each \specpull{3314}.
\item Clarified lookup for choices \specpull{3307}.
\item Constrain array assignment with implicit iterators \specpull{3306}.
\item Refence connector balancing restriction \specpull{3305}.
\item The connect-clause was renamed to be connect-equation \specpull{3304}.
...
\item Don't say that String supports String, because it doesn't \specpull{3288}.
\item Correct broken link for a paper \specpull{3281}.
\item Improvements in the style of presentations:
\begin{itemize}
\item Transformation-annotation, \specpull{3326} correcting \specissue{3275}.
\item Explained quote around code fragments, \specpull{3324}.
\end{itemize}
...
\item Support search and copying of ligatures \specpull{3296}, \specpull{3294}.
\end{itemize}
\end{itemize}
