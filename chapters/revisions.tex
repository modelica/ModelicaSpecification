...
\item
  Further clarified \lstinline!initial()! for when-clauses, \autoref{initialization-initial-equation-and-initial-algorithm}, and indicated that this appendix is not normative.
...
\item
  Initial equations are discrete --- used in MSL for initialization of pre-variables, \autoref{discrete-time-expressions}.
...
\item
  Constants can once again be modified unless declared final --- as this is already used in packages.  (See \autoref{constant-expressions}).
\item
