...
\item
  Refined when-clause:
  The \lstinline!nondiscrete!\index{nondiscrete@\indexinline{nondiscrete} (removed keyword)} keyword is removed, equations in when-clauses must have a unique variable name on left hand side variable and the exact mapping of when-clauses to equations is defined.
