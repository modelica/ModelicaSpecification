...
\begin{itemize}
\item Clarified predefined type names, \specpull{3325} correcting \specissue{2813}.
\item Only restrict public connectors in blocks, \specpull{3318} correcting \specissue{3309}.
...
\item Clarified each \specpull{3314} correcting \specissue{3052}.
\item Clarified lookup for choices \specpull{3307}.
\item Constrain array assignment with implicit iterators \specpull{3306} correcting \specissue{3250}.
\item Refence connector balancing restriction \specpull{3305} correcting \specissue{3260}.
...
\item Don't say that String supports String, because it doesn't \specpull{3288} correcting \specissue{3264}.
\item Correct broken link for a paper \specpull{3281}.
\item Clarify the difference between when-equations and clocked when \specpull{3279} correcting \specissue{3001}.
\item Clean-up of terminology related to connection equations \specpull{3277} correcting \specissue{3273}.
\item Clarify String named argument combinations  \specpull{3262}.
\item Specify that extent and preserveAspectRatio use the same logic \specpull{3253} correcting \specissue{3219}. 
...
\item Adjust non-normative description of smoothOrder \specpull{3237} correcting \specissue{3200}. 
\item Clarify role of protected components passed to external functions \specpull{3236} correcting \specissue{3188}.
\item Add example for shiftSample \specpull{3233} correcting \specissue{3040}. 
\item Add clocked discrete-time expressions to discrete-time, \specpull{3231} correcting \specissue{3116}.
\item Clarify record type compatible \specpull{3230} correcting \specissue{3145}.
\item Extend choicesAllMatching to records, \specpull{3229} correcting \specissue{3210}.
...
\item Clarify elsewhen \specpull{3217} and \specpull{3228} correcting \specissue{3216}.
...
\item Clarify previous parameter expression \specpull{3214} correcting \specissue{3074}.
\item Annotation to limit number of connections \specpull{3212} and \specpull{3129} correcting \specissue{3117}.
\item Forbid combination of parameter and input, \specpull{3211} correcting \specissue{3141}.
\item Add directorySelector \specpull{3207}.
\item Explain abs no event  clarification \specpull{3202}.
\item Clarify that URIs shall also be converted \specpull{3201} correcting \specissue{3199}.
\item Clarify non-normative text for expandable connectors \specpull{3197} and \specpull{3195} correcting \specissue{3194}.
\item Remove arrayLayout since most tools have not implemented it, \specpull{3196} correcting \specissue{3189}.
\item Mandatory ignoring of trailing "1" in defaultComponentName, \specpull{3186} correcting \specissue{3151}.
...
\item Simplified presentation of Transformation-annotation, \specpull{3326} correcting \specissue{3275}.
\item Explained quote around code fragments, \specpull{3324} correcting \specissue{3191}.
...
\item Fix grammar 'is' -> 'are' \specpull{3272} correcting \specissue{3271}.
\item Add 'cat' to document index  \specpull{3268}.
\item Fix missing formatting of "T" \specpull{3267}.
\item Work-around for table issue in LaTeXML \specpull{3208} and \specpull{3205} correcting \specissue{3156}.
\item Add 'time' to document index \specpull{3203}.
\item Remove spurious semi-colons \specpull{3193} correcting \specissue{3192}.
\item Clarified description of BaseProperties in example \specpull{3190}.
\end{itemize}
\item Improvements in build system:
\begin{itemize}
...
\item Support search and copying of ligatures \specpull{3296}, \specpull{3294} correcting \specissue{3286}.
\end{itemize}
\end{itemize}
