...
\item
  ...
  \autoref{connectors-and-connections}. Ticket \href{https://trac.modelica.org/Modelica/ticket/757}{\#757}.
\item
...
\item
  ...
  \item
    ...
    standardized platform names like win32; see \autoref{annotations-for-external-libraries-and-include-files}; resolves
    ticket \#297).
  \item
  ...
  \item
    ...
    (new annotation showStartAttribute; see \autoref{annotations-for-the-graphical-user-interface}).
  \item
    Access control for packages to protect intelectual property.\\
    (new annotations Protection, and License; see new \autoref{annotations-for-access-control-to-protect-intellectual-property}).
  \end{itemize}
\end{itemize}
