...
Given those initial values the equations are simulated forward in time, the transient analyis.
...
After solving the initialization problem, simulation proceeds with transient analysis in the following way:
\begin{enumerate}
