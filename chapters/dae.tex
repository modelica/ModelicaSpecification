...
Given those initial values the equations are simulated forward in time, this is also called solving an \firstuse{initial value problem}.
...
After solving the initialization problem, simulation proceeds in the following way:
\begin{enumerate}
