...
It is called \emph{redundancy} since this number \lstinline!connect!-equations could be removed without changing the connection set or the generated equations.
