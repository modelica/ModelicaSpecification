...
\item
  ...
  For \lstinline!connect(A, B)! with overdetermined connector \lstinline!R! this corresponds to the edge \lstinline!A.R! to \lstinline!B.R! generating the equation \lstineline!A.R = B.R!.
\item
