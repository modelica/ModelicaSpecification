...
\end{enumerate}
If there are no redundant \lstinline!connect!-equations, the breakable branches can be chosen to correspond to the \lstinline!connect!-equations for overdetermined connectors.
