...
Only the overdetermined connector components are considered.
...
\end{enumerate}
If there are no redundant connect-equations the breakable branches will correspond to the connect-equations for overdetermined connectors, otherwise this will only generate branches for a subset of them.
