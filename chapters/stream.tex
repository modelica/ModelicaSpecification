...
If at least one variable in a connector has the \lstinline!stream!\indexinline{stream} prefix, the connector is called \firstuse{stream connector}\index{stream!connector} and the corresponding variable is called \firstuse{stream variable}\index{stream!variable}.
...
This value is computed from the \firstuse{stream connection equations}\index{stream connection equations}\index{connection equations!stream} of the flow variables and of the stream variables.
