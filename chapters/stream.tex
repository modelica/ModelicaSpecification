...
%TODO-BACK This chapter uses _ in code blocks and inline code. This is no real Modelica code, but indicates a mathematical index. Needs to be checked and formatted in a proper way.
% For inline code, one could use \texttt{m\textsubscript j}
...
\texttt{m\textsubscript{j}.c} (j=1,2,...,N) and \lstinline[basicstyle=\ttfamily]!M! outside connectors
