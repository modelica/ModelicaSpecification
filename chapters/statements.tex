...
\lstinline!if!-statements\index{if@\robustinline{if}!statement}\index{then@\robustinline{then}!if-statement@\robustinline{if}-statement}\index{else@\robustinline{else}!if-statement@\robustinline{if}-statement}\index{elseif@\robustinline{elseif}!if-statement@\robustinline{if}-statement} have the following syntax:
\begin{lstlisting}[language=grammar]
if expression then
  { statement ";" }
...
See \cref{assert}.
A failed \lstinline!assert!\index{assert@\robustinline{assert}!statement@\robustinline{statement}} stops the execution of the current algorithm.
