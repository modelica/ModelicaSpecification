...
\end{lstlisting}
The statements inside the when-statement are activated when either \lstinline!x! becomes \textgreater{} 2 or
\lstinline!sample(0, 2)! becomes \lstinline!true! or \lstinline!x! becomes \textless{} 5:
\begin{lstlisting}[language=modelica]
