...
\lstinline!Library = {"libraryName1", "libraryName2"}! is used to tell the linker to include the library files where the compiled external function is available and additional libraries used to implement it.
