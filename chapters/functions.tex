...
\item
  as a function that is a component (that is a formal parameter of function type of the enclosing function),
\item
...
or just a dll-file. It may not refer to a single obj-file.
