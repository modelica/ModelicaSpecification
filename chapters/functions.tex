...
Only if the function formal parameter is \lstinline!impure!, it is allowed to pass an \lstinline!impure! function to it, due to \cref{function-compatibility-or-function-subtyping-for-functions}.
