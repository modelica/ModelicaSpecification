...
\item
  ...
  To indicate failure, the \lstinline!constructor! may return a null pointer as an alternative to invoking functions like \lstinline[language=C]!ModelicaError!.
