...
\item
  ...
  \item
    ...
    Include guards should be used (either in the \lstinline!Include! annotation or in the source file) to avoid relying on the deprecated feature that tools shall not include multiple copies in the same translation unit.
