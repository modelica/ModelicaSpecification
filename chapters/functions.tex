...
\item
    The
% Workaround for LaTeXML issue with long arguments to \lstinline (fixed on master 2025-05-07):
% - https://github.com/brucemiller/LaTeXML/issues/2553 (marked as fixed as of commit 863dd73)
\ifpdf
\lstinline!annotation(License="modelica:/ModelicaLibraryName/Resources/Licenses/MyLicense.txt")!%
\else
\lstinline!annotation(License=!%
\lstinline!"modelica:/ModelicaLibraryName/Resources/Licenses/MyLicense.txt")!%
\fi%
\annotationindex{License},
