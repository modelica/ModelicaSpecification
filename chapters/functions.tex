...
\item
  The {\lstinline!annotation(Include="insertedCode")!}\annotationindex{Include}, used to insert function prototypes or definitions needed for calling the external function in the code generated by the Modelica compiler.
...
%   See also \cref{utility-functions} for recommended ways of using the functions in \filename{ModelicaUtilities.h}.
  ...
  \end{nonnormative}
\item
  The {\lstinline!annotation(IncludeDirectory="modelica:/$\mathit{TopPackage}$/Resources/Include")!}\annotationindex{IncludeDirectory}, used to specify a location for header files.
...
\item
  The {\lstinline!annotation(LibraryDirectory="modelica:/$\mathit{TopPackage}$/Resources/Library")!}\annotationindex{LibraryDirectory}, used to specify a location for library files.
  ...
  \end{itemize}
\item
  The {\lstinline!annotation(SourceDirectory="modelica:/$\mathit{TopPackage}$/Resources/Source")!}\annotationindex{SourceDirectory}, gives the location for source files.
...
\item
  The {\lstinline!annotation(License="modelica:/$\mathit{TopPackage}$/Resources/Licenses/MyLicense.txt")!}\annotationindex{License}, gives the license text file for the function.
...
The {\lstinline!$\mathit{TopPackage}$!} used for {\lstinline!IncludeDirectory!}, {\lstinline!LibraryDirectory!}, and {\lstinline!SourceDirectory!} indicates the top-level class where the annotation is found in the Modelica source code.
