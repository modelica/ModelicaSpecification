...
See \cref{modelica:CStructName} and \cref{modelica:CName} regarding the struct tag and the member names.
...
A default struct member name which is not a valid in C is allowed, provided that the record class does not appear in the input and output types of any \lstinline!external!-clause.
\end{semantics}
\end{annotationdefinition}
