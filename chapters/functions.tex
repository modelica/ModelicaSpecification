...
\item
  The
  {\lstinline!annotation(IncludeDirectory="modelica:/$\mathit{TopPackage}$/Resources/Include")!}\annotationindex{IncludeDirectory}, used to specify a location for header files.
...
\item
  The
  {\lstinline!annotation(LibraryDirectory="modelica:/$\mathit{TopPackage}$/Resources/Library")!}\annotationindex{LibraryDirectory}, used to specify a location for library files.
...
\item
  The
  {\lstinline!annotation(SourceDirectory="modelica:/$\mathit{TopPackage}$/Resources/Source")!}\annotationindex{SourceDirectory}, gives the location for source files.
