...
This can occur for the deprecated case of external functions assumed to be pure, or when using \lstinline!pure(expression)! to call an impure function in a pure function.
\end{nonnormative}
