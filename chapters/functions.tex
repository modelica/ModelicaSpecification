...
The struct members may be in a different order compared to the record components, and additional padding or fields may exist.
...
The annotation \lstinline!CStructName = "CName"! specifies that \lstinline[language=C]!CName! is the name of the struct in the C mapping of the Modelica record class.

By default the struct member names are the same as the record component names, but a different name can be specified using the \lstinline!CStructName! annotation.
...
If multiple record classes with \lstinline!CStructName! annotation have the same \lstinline!CName!, the records must be type compatible.
\end{semantics}
\end{annotationdefinition}
...
The annotation \lstinline!CName = "CName"! specifies that the name of the C struct member corresponding to the record component is \lstinline[language=C]!CName!.
\end{semantics}
\end{annotationdefinition}
