...
If \lstinline!GenerateEvents = true!, the model developer proposes that crossing functions in the function should generate events.
As defaults this implies \lstinline!Inline = true!, but it can be overriden by specifying one of the inline-annotations (with true value).
