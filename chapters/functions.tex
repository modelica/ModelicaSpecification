...
%   See also \cref{utility-functions} for recommended ways of using the functions in \filename{ModelicaUtilities.h}.
  ...
  \end{nonnormative}
\item
  The {\lstinline!annotation(IncludeDirectory="modelica:/PackageName/Resources/Include")!}\annotationindex{IncludeDirectory}, used to specify a location for header files.
...
\item
  The {\lstinline!annotation(LibraryDirectory="modelica:/PackageName/Resources/Library")!}\annotationindex{LibraryDirectory}, used to specify a location for library files.
  ...
  \end{itemize}
\item
  The {\lstinline!annotation(SourceDirectory="modelica:/PackageName/Resources/Source")!}\annotationindex{SourceDirectory}, gives the location for source files.
