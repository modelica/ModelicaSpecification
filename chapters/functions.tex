...
\item
  Components of a function follow special variability rules, see \cref{discrete-time-expressions} for details.
  In particular the annotation \lstinline!GenerateEvents=true! makes this complicated.
\end{itemize}
