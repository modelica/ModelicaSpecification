...
\end{lstlisting}
As the value of {\lstinline!x!} varies over the interval $[-0.5,\, 0.5]$, but the range of {\lstinline!cbrtPos!} is only $(0, \infty)$, the informal codomain of {\lstinline!cbrtPos!} cannot be restricted such that the surjectiveness is fulfilled.
...
{\lstinline!License!} & License files & \Cref{modelica:License}\\
\hline
\end{tabular}
\end{center}
...
\begin{annotationdefinition}[License]
\begin{synopsis}\begin{lstlisting}
