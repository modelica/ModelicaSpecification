...
the same and that $f_2$ should have exactly the same union of output and formal
parameters as $f_1$, but the order of the formal
...
If"$f_1$" computes the inverse of "$f_2$" within a region, or up to a certain tolerance,
the "$f_1$" may specify "$f_2$"as inverse with fewer arguments, skipping the arguments for tolerance and/or the region.
