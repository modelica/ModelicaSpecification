...
Formal parameters are specified using the \lstinline!input!\index{input@\robustinline{input}} keyword, whereas results are denoted using the \lstinline!output!\index{output@\robustinline{output}} keyword.
...
The return-statement\index{return@\robustinline{return}} terminates the current function call, see \cref{function-call}.
...
\item
  ...
  They can be explicitly marked as \lstinline!pure!\index{pure@\robustinline{pure}}.
  \begin{nonnormative}
...
With the prefix keyword \lstinline!impure!\index{impure@\robustinline{impure}} it is stated that a Modelica function is \emph{impure} and it is only allowed to call such a function from within:
\begin{itemize}
\item
...
The format of an external\index{external@\robustinline{external}} function declaration is as follows.
\begin{lstlisting}[language=grammar]
...
The \lstinline[language=grammar]!language-specification! must currently be one of \lstinline!"builtin"!, \lstinline!"C"!, \lstinline!"C..."! (for one of the specific C standards like C89, C99, and C11 -- specifying
...
\index{ModelicaMessage@\robustinline{ModelicaMessage}}\index{ModelicaWarning@\robustinline{ModelicaWarning}}\index{ModelicaError@\robustinline{ModelicaError}}
...
\index{ModelicaFormatMessage@\robustinline{ModelicaMessage}}\index{ModelicaFormatWarning@\robustinline{ModelicaWarning}}\index{ModelicaFormatError@\robustinline{ModelicaError}}
\begin{synopsis}[C]
...
\index{ModelicaVFormatMessage@\robustinline{ModelicaMessage}}\index{ModelicaVFormatWarning@\robustinline{ModelicaWarning}}\index{ModelicaVFormatError@\robustinline{ModelicaError}}
\begin{synopsis}[C]\begin{lstlisting}
...
\begin{itemize}
\item
  There is a predefined partial class \lstinline!ExternalObject!\index{ExternalObject@\robustinline{ExternalObject}}.
  \begin{nonnormative}
