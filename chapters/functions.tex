...
\item
  The {\lstinline!annotation(License="modelica:/ModelicaLibraryName/Resources/Licenses/$\mathit{myLicense.txt}$")!}\annotationindex{License}, gives the license text file for the function.
