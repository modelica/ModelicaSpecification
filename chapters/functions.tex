...
For \lstinline!when!-equations, \lstinline!when!-statements, initial equations, initial algorithms, and bindings it is an error if the function calls are part of systems of equations and thus have to be called multiple times.
