...
\autoref{records} and it is mapped to the type \lstinline[basicstyle=\ttfamily]!T'! as defined in these sections
for input arguments.
...
\item
  The
  \lstinline[basicstyle=\ttfamily]!annotation(IncludeDirectory="modelica://LibraryName/Resources/Include")!,
...
\item
  The
  \lstinline[basicstyle=\ttfamily]!annotation(LibraryDirectory="modelica://LibraryName/Resources/Library")!,
...
The \lstinline[basicstyle=\ttfamily]!LibraryName! used for \lstinline[basicstyle=\ttfamily]!IncludeDirectory! and \lstinline[basicstyle=\ttfamily]!LibraryDirectory!
