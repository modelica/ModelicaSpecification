...
As an alternative to specifying an array of strings, they all can also specify a scalar value instead as indicated explicitly only for the {\lstinline!Library!} annotation.
