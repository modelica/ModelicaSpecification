...
For identifiers the redundant escapes (\lstinline[basicstyle=\ttfamily]!'\?' and '\"'!) are the same as the corresponding non-escaped
variants (\lstinline[basicstyle=\ttfamily]!'?' and '"'!). {[}\emph{The single quotes are part of an
...
\item
  ...
  lexical unit.
\item
  String constant concatenation \lstinline[basicstyle=\ttfamily]!"a" "b"! becoming \lstinline[basicstyle=\ttfamily]!"ab"! (as in C) is
  replaced by the \lstinline[basicstyle=\ttfamily]!"+"! operator in Modelica.
\item
  Modelica uses the same comment syntax as C++ and Java (i.e., \lstinline[basicstyle=\ttfamily]!//!
  signals the start of a line comment and \lstinline[basicstyle=\ttfamily]!/*! .... \lstinline[basicstyle=\ttfamily]!*/! is a multi-line
...
\item
  ...
  \lstinline[basicstyle=\ttfamily]!<HTML>! and \lstinline[basicstyle=\ttfamily]!</HTML>! or
  \lstinline[basicstyle=\ttfamily]!<html>! and \lstinline[basicstyle=\ttfamily]!</html>!
