...
record Documentation
  ...
  String[:] styleSheets = fill("", 0) "Style sheets for documentation";
end Documentation;
\end{lstlisting}

The \lstinline!styleSheets! may also be given as a single string, see \cref{style-sheets}.
The \lstinline!figures! is described in \cref{figures}, if missing it is interpreted as if no figures are given in the model.
