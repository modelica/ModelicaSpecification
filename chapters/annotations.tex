...
If the icon of a class used in a diagram is missing graphics then tools shall show a tool-dependent outline of the extent of the component to improve usability.
