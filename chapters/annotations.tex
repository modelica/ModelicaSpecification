...
If the icon of a component placed in a diagram layer does not contain any graphical primitives (including inherited ones, and regardless of visibility; but excluding connectors), tools shall show a tool-dependent rudimentary outline of the component's transformed \lstinline!extent!.
