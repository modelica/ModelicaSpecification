...
In the case of hierarchical components it is applied to all components, and in both of them have annotations then \lstinline!Evaluate = true! takes precedence.
