...
The $layer$ is a \lstinline!String! literal where \lstinline!"info"! means information layer, i.e., the documentation of the class, \lstinline!"diagram"! means diagram layer, \lstinline!"icon" means icon layer, and \lstinline!"text"! means the Modelica text layer.

\begin{nonnormative}
Tools may also support these values without quotes, e.g., \lstinline!info!, as a deprecated feature.
\end{nonnormative}
