...
The string arguments for these functions shall not be the empty string.
...
These functions can be called with literal strings or arrays of strings and vectorize according to \cref{scalar-functions-applied-to-array-arguments}.
...
An empty string would either mean an empty diagnostics, a missing class or component, or a modifier which does not make sense.
\end{nonnormative}
