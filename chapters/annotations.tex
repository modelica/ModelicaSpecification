...
\section{Notation for Annotation Definitions}\label{how-to-interpret-annotation-definitions}
...
For an array record member, the special expression \lstinline!{}! in a declaration equation indicates that the array is empty by default.
...
record Figure
  ...
  /*literal*/ constant String group = "" "Name of plot group";
...
\begin{lstlisting}[language=modelica]
/*literal*/ constant String mustBeConnected = "$\mathit{message}$";
\end{lstlisting}%
...
A connector component declaration may have the following annotation:
\begin{lstlisting}[language=modelica]
/*literal*/ constant String mayOnlyConnectOnce = "$\mathit{message}$";
\end{lstlisting}%
...
\begin{lstlisting}[language=modelica]
/*literal*/ constant String versionDate   "UTC date of first version build (in format: YYYY-MM-DD)";
/*literal*/ constant Integer versionBuild "Larger number is a more recent maintenance update";
/*literal*/ constant String dateModified  "UTC date and time of the latest change to the package
