...
The $layer$ is a \lstinline!String! literal where \lstinline!"info"! means info layer, i.e., the documentation of the class, \lstinline!"diagram"! means diagram layer and \lstinline!"text"! means the Modelica text layer.
