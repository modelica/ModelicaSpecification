...
A component instance can be placed within the diagram and/or icon layer of the enclosing class.
Non-connector components are represented using their icon layer.
For connectors, the icon layer is used to represent the connector when it is shown in the icon layer of the enclosing class.
