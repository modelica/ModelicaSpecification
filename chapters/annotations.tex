...
When \lstinline!horizontalAlignment! is \lstinline!TextAlignment.Automatic!, the tool automatically determines the alignment to reduce collisions with other graphical items.
...
The \lstinline!horizontalAlignment = TextAlignment.Automatic! is not allowed within this \lstinline!Text! annotation (compare \cref{connections1}).
