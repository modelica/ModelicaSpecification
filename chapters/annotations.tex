...
Modelica.Electrical.Machines.BasicMachines.QuasiStationaryDCMachines.DC_ElectricalExcited a;
Boolean b=a.quasiStationary;
\end{lstlisting}
to
\begin{lstlisting}[language=modelica]
...
Modelica.Electrical.Machines.BasicMachines.QuasiStaticDCMachines.DC_ElectricalExcited a;
...
in the original library where \lstinline!DC_ElectricalExcited! inherit from \lstinline!PartialBasicDCMachine!.
\end{example}
