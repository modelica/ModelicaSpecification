...
Note that the collection of license text files is only intended as a help, thus there is no need for a strict definition of distributable version or stricter rules for including the license text files.
