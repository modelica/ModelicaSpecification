...
If there is not exactly one vector of connectors for a each variable \lstinline!n! with \lstinline!connectorSizing = true! diagnostics are needed, but the model may otherwise work.
