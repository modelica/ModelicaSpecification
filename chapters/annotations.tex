...
When the default behavior corresponds to a specific value for annotation that is given as a default.
When the default value is missing the default behavior is generally explained in more detail.
...
If the \lstinline!TestCase! annotation is missing it is a normal model -- there are thus no restriction on the use of the model, and the model should not contain errors.
