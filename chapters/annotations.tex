...
If a component has \lstinline!visible = true! (the default) it can be shown, otherwise it shall not be shown.
...
Sub-connectors in a hierarchical connector should only be shown when they can be connected to.
