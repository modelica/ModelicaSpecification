...
The deprecated special case \lstinline!convertElement("OldClass", "OldName", "")! is equivalent to \lstinline!convertModifiers("OldClass",{"OldName"},fill("",0))! and no and no conversion is applied to any equations.
\end{nonnormative}
