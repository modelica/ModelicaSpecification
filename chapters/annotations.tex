...
%TODO-BACK How ot change NAME and normallyConstant in emph?
...
%TODO-BACK How to change allowbreak? -> remove, add lstlisting
...
%TODO-BACK How to format emph + code: Versions and Convert
\begin{itemize}
\item
...
\item
  \lstinline[basicstyle=\ttfamily]!conversion(from(version = Versions, [to=VERSION-NUMBER,]!
  Convert))\\
  ...
  and \emph{Convert} is  \lstinline[basicstyle=\ttfamily]!script="..."! \textbar{}
