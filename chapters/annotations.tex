...
If a component has \lstinline!visible! being \lstinline!true! (the default) it can be shown, otherwise it shall not be shown.
...
Public connectors are shown in both the diagram layer and the icon layer, the sub-connectors in a hierarchical connector should only be shown when they can be connected to.
