...
\begin{annotationdefinition*}[figures]\label{modelica:Documentation.figures}\annotationindex{figures}\index{Documentation@\robustinline{Documentation}!\robustinline{figures} sub-annotation}\annotationindex{Figure}
\begin{synopsis}\begin{lstlisting}
record Documentation
  Figure[:] figures;
  $\ldots$
...
Details about the \lstinline!Figure! record, including a definition of the \lstinline!Plot! record, are given in \cref{figure-plot-properties}.
\end{semantics}
\end{annotationdefinition*}
...
For connectors, the icon layer is used to represent a connector when it is shown in the icon layer of the enclosing class.
The diagram layer of the connector is used to represent it when shown in the diagram layer of the enclosing class.
...
Visibility and placement can be controlled using the \lstinline!Placement! annotation.
...
The \lstinline!iconVisible! only applies to public connector components, and defines the visibility of the component in the icon layer of the enclosing class.
The connector's icon layer defined the content to be displayed.
