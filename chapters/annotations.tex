...
For a top-level class the {\lstinline!annotation(License="modelica:/$\mathit{TopPackage}$/Resources/Licenses/MyLicense.txt")!}\annotationindex{License}, gives a license text file for the class.
