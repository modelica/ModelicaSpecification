...
The \lstinline!extent! and \lstinline!rotation! (inherited from \lstinline!GraphicItem!) are relative to the \lstinline!origin! (default \lstinline!{0, 0}!, inherited from \lstinline!GraphicItem!) and the \lstinline!origin! is relative to the point on the \lstinline!Line!.
...
The \lstinline!textColor! defines the color of the text.
