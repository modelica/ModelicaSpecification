...
If a non-parameter declaration has a modifier for the \lstinline!start!-attribute and does not have \lstinline!showStartAttribute = false! the \lstinline!start!- and \lstinline!fixed!-attributes may also be show.
