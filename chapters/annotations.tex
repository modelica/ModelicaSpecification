...
{[}\emph{This annotation is for example used in}
\lstinline!Modelica.Mechanics.Rotational.Sources.Move! \emph{to define that an input
...
with transparent background and no border around the text (and without
outline). The contents inherited from \lstinline!FilledShape! is deprecated.
...
\lstinline!simplify! \emph{is primarily intended for converting enumerations and emulated
