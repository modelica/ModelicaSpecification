...
The exponentiation is defined mathematically as repeated multiplication, with a identity matrix of suitable type as the result for $\text{\lstinline!s!} = 0$, e.g.:
\begin{lstlisting}[language=modelica]
a^1 = a;
a^2 = a * a;
a^3 = a * a * a;
