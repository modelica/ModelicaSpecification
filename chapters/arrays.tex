...
\item
  ...
  the enumerated type)
\item
  Binding equations of the form \lstinline[basicstyle=\ttfamily]!x1 = x2! as well as declaration
  assignments of the form \lstinline[basicstyle=\ttfamily]!x1 := x2! are allowed for arrays independent of
...
Zero-valued dimensions are allowed, so: \lstinline[basicstyle=\ttfamily]!C x[0];! declares an empty
  vector and: \lstinline[basicstyle=\ttfamily]!C x[0,3]!; an empty matrix.
{[}\emph{Special cases}:
...
size of the} \lstinline[basicstyle=\ttfamily]!di!\emph{-dimension, then an assert statement}
\lstinline[basicstyle=\ttfamily]!assert(i>=0, ...)! \emph{is generated provided this
...
the} \lstinline[basicstyle=\ttfamily]!di!\emph{-dimension. Then for every such index-access an assert
statement} \lstinline[basicstyle=\ttfamily]!assert(i>=1 and i<=size(A,di), ...!
...
\lstinline[basicstyle=\ttfamily]!Integer!, \lstinline[basicstyle=\ttfamily]!Boolean!, or \lstinline[basicstyle=\ttfamily]!enumeration! values are as follows:
...
\item
  An array dimension indexed by \lstinline[basicstyle=\ttfamily]!Boolean! values has the lower bound \lstinline[basicstyle=\ttfamily]!false!
  and the upper bound \lstinline[basicstyle=\ttfamily]!true!.
\item
  An array dimension indexed by \lstinline[basicstyle=\ttfamily]!enumeration! values of the type
  \lstinline[basicstyle=\ttfamily]!E=enumeration!(\lstinline[basicstyle=\ttfamily]!e1!, \lstinline[basicstyle=\ttfamily]!e2!, ..., \lstinline[basicstyle=\ttfamily]!en!) has the lower bound \lstinline[basicstyle=\ttfamily]!E.e1! and the upper
  bound \lstinline[basicstyle=\ttfamily]!E.en!.
\end{itemize}
...
The following \lstinline[basicstyle=\ttfamily]!promote! function cannot be used in Modelica, but is
...
{[}\emph{The function} \lstinline[basicstyle=\ttfamily]!promote! \emph{cannot be used in Modelica, because
the number of dimensions of the returned array cannot be determined at
compile time if n is a variable. Below,} \lstinline[basicstyle=\ttfamily]!promote! \emph{is only used for
constant n}.
...
\emph{Modelica} & \emph{Explanation}\\ \hline
\endhead
\lstinline[basicstyle=\ttfamily]!scalar(A)! & Returns the single element of array A. size(A,i) = 1 is required for 1
\textless{}= i \textless{}= ndims(A).\\ \hline
\lstinline[basicstyle=\ttfamily]!vector(A)!
& 
...
\lstinline[basicstyle=\ttfamily]!matrix(A)!
& 
...
\lstinline[basicstyle=\ttfamily]!fill!(s,$n_1$,$n_2$,$n_3$,...) =
\lstinline[basicstyle=\ttfamily]!fill!(\lstinline[basicstyle=\ttfamily]!fill!(s,$n_2$,$n_3$, ...),
$n_1$,); \lstinline[basicstyle=\ttfamily]!fill!(s,n)=\{s,s,\ldots{}, s\}

The function needs two or more arguments; that is fill(s) is not
legal.\\ \hline
\lstinline[basicstyle=\ttfamily]!linspace(x1,x2,n)!
&
Returns a Real vector with n equally spaced elements, such that
v=\lstinline[basicstyle=\ttfamily]!linspace!(x1,x2,n),
...
%TODO-BACK Check if all code is transformed \lstinline[basicstyle=\ttfamily]! vs. \lstinline
\begin{longtable}{|p{4.1cm}|p{10.1cm}|}
\caption{Array reduction functions and operators.}\\
\hline
\emph{Modelica} & \emph{Explanation}\\ \hline
\endhead
\lstinline[basicstyle=\ttfamily]!min(A)!
&
Returns the least element of array expression A; as defined by
\textless{}.\\ \hline
\lstinline[basicstyle=\ttfamily]!min(x,y)!
&
Returns the least element of the scalars x and y; as defined by
\textless{}.\\ \hline
\begin{tabular}{@{}p{4cm}@{}}
\lstinline[basicstyle=\ttfamily]!min(e(i, ..., j)!\\
\lstinline[basicstyle=\ttfamily]! for i in  u,!\\
\lstinline[basicstyle=\ttfamily]!   ...,  j in  v)!
\end{tabular}
&
...
in v:
\end{tabular}\\ \hline
\lstinline[basicstyle=\ttfamily]!sum(A)!
&
\begin{tabular}{@{}p{10cm}@{}}
Returns the scalar sum of all the elements of array expression:\\
\lstinline[basicstyle=\ttfamily]!A[1,...,1]+A[2,...,1]+....+A[end,...,1]+A[end,...,end]!
\end{tabular}\\ \hline
\begin{tabular}{@{}p{5cm}@{}}
\lstinline[basicstyle=\ttfamily]!sum(e(i, ..., j)!\\
\lstinline[basicstyle=\ttfamily]! for i in  u,!\\
\lstinline[basicstyle=\ttfamily]!   ...,  j in  v)!
\end{tabular}
&
...
\end{tabular}\\ \hline
\lstinline[basicstyle=\ttfamily]!product(A)!
&
\begin{tabular}{@{}p{10cm}@{}}
...
\end{tabular}\\ \hline
\begin{tabular}{@{}p{4cm}@{}}
\lstinline[basicstyle=\ttfamily]!product(e(i, ..., j)!\\
\lstinline[basicstyle=\ttfamily]! for i in  u,!\\
\lstinline[basicstyle=\ttfamily]!   ...,  j in  v)!
\end{tabular}
&
...
the loop-variable, \lstinline[basicstyle=\ttfamily]!IDENT!, is in scope inside \lstinline[basicstyle=\ttfamily]!expression1!. The
loop-variable may hide other variables, as in for-clauses. The result
depends on the \lstinline[basicstyle=\ttfamily]!function-name!, and currently the only legal
function-names are the built-in operators \lstinline[basicstyle=\ttfamily]!array!, \lstinline[basicstyle=\ttfamily]!sum!,
\lstinline[basicstyle=\ttfamily]!product!, \lstinline[basicstyle=\ttfamily]!min!, and
\lstinline[basicstyle=\ttfamily]!max!. For array, see \autoref{vector-matrix-and-array-constructors}. If \lstinline[basicstyle=\ttfamily]!function-name! is
\lstinline[basicstyle=\ttfamily]!sum!, \lstinline[basicstyle=\ttfamily]!product!, \lstinline[basicstyle=\ttfamily]!min!,
or \lstinline[basicstyle=\ttfamily]!max! the result is of the same type as \lstinline[basicstyle=\ttfamily]!expression1! and is constructed
by evaluating \lstinline[basicstyle=\ttfamily]!expression1! for each value of the loop-variable and
computing the \lstinline[basicstyle=\ttfamily]!sum!, \lstinline[basicstyle=\ttfamily]!product!, \lstinline[basicstyle=\ttfamily]!min!, or
\lstinline[basicstyle=\ttfamily]!max! of the computed elements. For
...
\endhead
\lstinline[basicstyle=\ttfamily]!sum! & Integer or Real & \lstinline[basicstyle=\ttfamily]!zeros(...)!\\ \hline
\lstinline[basicstyle=\ttfamily]!product! & Scalar Integer or Real & \lstinline[basicstyle=\ttfamily]!1!\\ \hline
\lstinline[basicstyle=\ttfamily]!min! & Scalar enumeration, Boolean, Integer or Real & 
\begin{tabular}{@{}p{6cm}@{}}
Greatest value of type\\( \lstinline[basicstyle=\ttfamily]!Modelica.Constants.inf! for Real)
\end{tabular}\\ \hline
\lstinline[basicstyle=\ttfamily]!max! & Scalar enumeration, Boolean, Integer or Real &
\begin{tabular}{@{}p{6cm}@{}}
Least value of type\\ ( \lstinline[basicstyle=\ttfamily]!-Modelica.Constants.inf! for Real)
\end{tabular}\\ \hline
...
\lstinline[basicstyle=\ttfamily]!cross(x,y)!
...
\lstinline[basicstyle=\ttfamily]!skew(x)!
...
The constructor function \lstinline[basicstyle=\ttfamily]!array(A,B,C,...)! constructs an array from its
arguments according to the following rules:

\begin{itemize}
\item
  Size matching: All arguments must have the same sizes, i.e.,
  \lstinline[basicstyle=\ttfamily]!size(A)=size(B)=size(C)=!...
\item
...
\item
  ...
  argument arrays, i.e., \lstinline[basicstyle=\ttfamily]!ndims(array(A,B,C)) = ndims(A) + 1 = ndims(B) + 1, ...!
\item
  \lstinline[basicstyle=\ttfamily]!{A, B, C, ...}! is a shorthand notation for \lstinline[basicstyle=\ttfamily]!array(A, B, C, ...)!.
\item
  There must be at least one argument {[}\emph{i.e.,} \lstinline[basicstyle=\ttfamily]!array()! \emph{or}
  \lstinline[basicstyle=\ttfamily]!{}! \emph{is not defined}{]}.
\end{itemize}
...
the loop-variable, \lstinline[basicstyle=\ttfamily]!IDENT!, is in scope inside expression in the array
...
replacing each '\lstinline[basicstyle=\ttfamily]!,!' by '\lstinline[basicstyle=\ttfamily]!} for!' and prepending the array constructor with
a '\lstinline[basicstyle=\ttfamily]!{!'.
...
The function \lstinline[basicstyle=\ttfamily]!cat(k,A,B,C,...)! concatenates arrays
\lstinline[basicstyle=\ttfamily]!A!,\lstinline[basicstyle=\ttfamily]!B!,\lstinline[basicstyle=\ttfamily]!C!,... along
...
The array indexing operator \emph{name}\lstinline[basicstyle=\ttfamily]![!\emph{...}\lstinline[basicstyle=\ttfamily]!]! is used to
...
\end{lstlisting}
\emph{if} ] \lstinline[basicstyle=\ttfamily]!x! \emph{is a vector,} \lstinline[basicstyle=\ttfamily]!x[1]! \emph{is a scalar, but the
slice} \lstinline[basicstyle=\ttfamily]!x[1:5]! \emph{is a vector (a vector-valued or colon index
expression causes a vector to be returned).}

{]}

{[}\emph{Examples given the declaration} \lstinline[basicstyle=\ttfamily]!x[n,m], v[k], z[i,j,p]!:
...
\endhead
\lstinline[basicstyle=\ttfamily]!x[1, 1]! & \lstinline[basicstyle=\ttfamily]!0! & Scalar\\ \hline
\lstinline[basicstyle=\ttfamily]!x[:, 1]! & \lstinline[basicstyle=\ttfamily]!1! & n -- Vector\\ \hline
\lstinline[basicstyle=\ttfamily]!x[1, :] or x[1]! & \lstinline[basicstyle=\ttfamily]!1! & m -- Vector\\ \hline
\lstinline[basicstyle=\ttfamily]!v[1:p]! & \lstinline[basicstyle=\ttfamily]!1! & p -- Vector\\ \hline
\lstinline[basicstyle=\ttfamily]!x[1:p, :]! & \lstinline[basicstyle=\ttfamily]!2! & p x m -- Matrix\\ \hline
\lstinline[basicstyle=\ttfamily]!x[1:1, :]! & \lstinline[basicstyle=\ttfamily]!2! & 1 x m - "row" matrix\\ \hline
\lstinline[basicstyle=\ttfamily]!x[{1, 3, 5\}, :]! & \lstinline[basicstyle=\ttfamily]!2! & 3 x m -- Matrix\\ \hline
\lstinline[basicstyle=\ttfamily]!x[: , v]! & \lstinline[basicstyle=\ttfamily]!2! & n x k -- Matrix\\ \hline
\lstinline[basicstyle=\ttfamily]!z[: , 3, :]! & \lstinline[basicstyle=\ttfamily]!2! & i x p -- Matrix\\ \hline
\lstinline[basicstyle=\ttfamily]!x[scalar([1]), :]! & \lstinline[basicstyle=\ttfamily]!1! & m -- Vector\\ \hline
\lstinline[basicstyle=\ttfamily]!x[vector([1]), :]! & \lstinline[basicstyle=\ttfamily]!2! & 1 x m - "row" matrix\\ \hline
...
Arrays can be indexed using values of enumeration types or the \lstinline[basicstyle=\ttfamily]!Boolean!
...
The expression \lstinline[basicstyle=\ttfamily]!end! may only appear inside array subscripts, and if used
in the i:th subscript of an array expression \lstinline[basicstyle=\ttfamily]!A! it is equivalent to
\lstinline[basicstyle=\ttfamily]!size(A,i)! provided indices to A are a subtype of Integer. If used inside
...
Equality \lstinline[basicstyle=\ttfamily]!a=b! and assignment \lstinline[basicstyle=\ttfamily]!a:=b! of scalars, vectors, matrices, and
...
Addition \lstinline[basicstyle=\ttfamily]!a+b! and subtraction \lstinline[basicstyle=\ttfamily]!a-b! of numeric scalars, vectors, matrices,
and arrays is defined element-wise and require \lstinline[basicstyle=\ttfamily]!size(a)=size(b)! and a
numeric type for \lstinline[basicstyle=\ttfamily]!a! and \lstinline[basicstyle=\ttfamily]!b!. Unary plus and minus are defined element-wise.
Addition a+b of string scalars, vectors, matrices, and arrays is defined
as element-wise string concatenation of corresponding elements from \lstinline[basicstyle=\ttfamily]!a!
and \lstinline[basicstyle=\ttfamily]!b!, and require \lstinline[basicstyle=\ttfamily]!size(a)=size(b)!.
...
Element-wise addition \lstinline[basicstyle=\ttfamily]!a.+b! and subtraction \lstinline[basicstyle=\ttfamily]!a.-b! of numeric scalars,
...
addition \lstinline[basicstyle=\ttfamily]!a.+b! of string scalars, vectors, matrices, and arrays is
...
\hline
\emph{Type of a} & \emph{Type of b} & \emph{Result of a} \lstinline[basicstyle=\ttfamily]!.+/.-! \emph{b}
& \emph{Operation c := a .+/.- b (j=1:n, k=1:m)}\\ \hline
\endhead
Scalar & Scalar & Scalar & c := a +/- b\\ \hline
...
\hline
\emph{Type of a} & \emph{Result of} \lstinline[basicstyle=\ttfamily]!+/-! \emph{a} & \emph{Operation c :=
+/- a (j=1:n, k=1:m)}\\ \hline
\endhead
...
Scalar multiplication \lstinline[basicstyle=\ttfamily]!s*a! or \lstinline[basicstyle=\ttfamily]!a*s! with numeric scalar s and numeric
scalar, vector, matrix or array \lstinline[basicstyle=\ttfamily]!a! is defined element-wise:
...
Element-wise multiplication \lstinline[basicstyle=\ttfamily]!a.*b! of numeric scalars, vectors, matrices
...
Multiplication \lstinline[basicstyle=\ttfamily]!a*b! of numeric vectors and matrices is defined only for
...
Division \lstinline[basicstyle=\ttfamily]!a/s! of numeric scalars, vectors, matrices, or arrays \lstinline[basicstyle=\ttfamily]!a! and
numeric scalars \lstinline[basicstyle=\ttfamily]!s! is defined element-wise. The result is always of real
type. In order to get integer division with truncation use the function
\lstinline[basicstyle=\ttfamily]!div!.
...
Element-wise division \lstinline[basicstyle=\ttfamily]!a./b! of numeric scalars, vectors, matrices or
...
Exponentiation "\lstinline[basicstyle=\ttfamily]!a^b!" is defined as pow(double a,double b) in the ANSI
C library if both "\lstinline[basicstyle=\ttfamily]!a!" and "\lstinline[basicstyle=\ttfamily]!b!" are Real scalars. A Real scalar value is
...
Element-wise exponentiation \lstinline[basicstyle=\ttfamily]!a.^b! of numeric scalars, vectors,
...
Exponentiation \lstinline[basicstyle=\ttfamily]!a^s! is defined if \lstinline[basicstyle=\ttfamily]!a! is a square numeric matrix and \lstinline[basicstyle=\ttfamily]!s!
is a scalar as a subtype of Integer with \lstinline[basicstyle=\ttfamily]!s>=0!. The
...
\begin{itemize}
\item
  If \lstinline[basicstyle=\ttfamily]!a! is an array containing scalar components and \lstinline[basicstyle=\ttfamily]!m! is a component of
  those components, the expression \lstinline[basicstyle=\ttfamily]!a.m! is interpreted as a slice operation. It returns the array of components \lstinline!{a{[1].m,  ...}!.
\item
  If \lstinline[basicstyle=\ttfamily]!m! is also an array component, the slice operation is valid only if \lstinline!size(a[1].m)=size(a[2].m)=...!
\item
...
The operators, \lstinline[basicstyle=\ttfamily]!and! and \lstinline[basicstyle=\ttfamily]!or! take expressions of Boolean type, which are
either scalars or arrays of matching dimensions. The operator \lstinline[basicstyle=\ttfamily]!not! takes
...
evaluation of \lstinline[basicstyle=\ttfamily]!and! and \lstinline[basicstyle=\ttfamily]!or! see \autoref{evaluation-order}.
...
\begin{lstlisting}[language=modelica]
  ...
  y = C*x + D*u
\end{lstlisting}
\emph{Assume n=0, p\textgreater{}0, q\textgreater{}0: Results in} \lstinline[basicstyle=\ttfamily]!y = D*u!
