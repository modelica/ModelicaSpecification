...
Exponentiation \lstinline!a ^ s! is defined if \lstinline!a! is a square matrix of a subtype of \lstinline!Real!, and \lstinline!s! is a scalar as a subtype of \lstinline!Integer! with $\text{\lstinline!s!} \geq 0$.
