...
\begin{operatordefinition*}[promote]\label{not-modelica-promote}\index{promote@\robustinline{promote}}
...
An expression\index{for@\robustinline{for}!reduction expression}:
...
For an iterator\index{in@\robustinline{in}!reduction expression}:
\begin{lstlisting}[language=grammar]
