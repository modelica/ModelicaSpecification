...
vector(s) or matrix as input(s) and returns a Real/Integer vector or matrix:
...
& Returns a square matrix where the diagonal elements and the elements above the
diagonal are identical to the corresponding elements of the square matrix A and
