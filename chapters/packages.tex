...
\begin{itemize}
\item Description strings of component declarations and classes, see uses of \lstinline[language=grammar]!description-string! in \cref{modelica-concrete-syntax}.
\item Certain strings inside annotations:
  \begin{itemize}
  \item \lstinline!Text.string! in a \lstinline!connect!-equation annotation, see \cref{connections1}.
  \item \lstinline!Text.textString! inside \lstinline!Icon! and \lstinline!Diagram! annotations, see \cref{text}.
  % henrikt-ma 2022-05: The section defining these annotations is a bit odd at the moment.
  % Keep an eye on this in case the annotations are moved to a more sutable section in the future.
  \item The \lstinline!missingInnerMessage!, \lstinline!obsolete!, and \lstinline!unassignedMessage! annotations, see \cref{graphical-user-interface}.
  \item All strings of the \lstinline!Dialog! annotation (\lstinline!Dialog.group!, \lstinline!Dialog.tab!, \lstinline!Dialog.loadSelector.caption!, \lstinline!Dialog.loadSelector.filter!, \lstinline!Dialog.saveSelector.caption!, \lstinline!Dialog.saveSelector.filter!), see \cref{graphical-user-interface}.
  \item \lstinline!info! and \lstinline!revisions! in the \lstinline!Documentation! annotation, see \cref{annotation-info-revisions}.
  \item The \lstinline!Figure.title!, \lstinline!Plot.title!, and \lstinline!Curve.legend! inside the \lstinline!Documentation.figures! annotation, see \cref{figures}.
  \end{itemize}
\end{itemize}
