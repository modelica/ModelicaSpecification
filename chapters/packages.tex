...
\begin{nonnormative}
\lstinline!import!-clauses in a package or class fill the following two needs:
\begin{itemize}
\item
...
\begin{itemize}
\item
  \lstinline!import!-clauses are \emph{not} inherited.
\item
  \lstinline!import!-clauses are not named elements of a class or package.
