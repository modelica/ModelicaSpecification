...
An \lstinline!import!-clause\index{import@\indexinline{import}} can occur in one of the following syntactic forms:
...
A within-clause\index{within@\indexinline{within}} has the following syntax:
