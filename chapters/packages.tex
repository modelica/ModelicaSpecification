...
In this case, the \lstinline[language=grammar]!stored-definition! shall only define a single class with name (here, \lstinline!A!) matching the name of the nonstructured entity.
