...
\lstinline!modelica://Modelica.Mechanics/C.jpg! is legal, while
\lstinline!modelica://Modelica/Mechanics/C.jpg! is illegal. The reference
\lstinline!modelica://Modelica.Mechanics/C.jpg! must also refer to a different
...
\lstinline!Modelica! \emph{,} \lstinline!MyLib!\emph{, and} \lstinline!ComplexNumbers!\emph{. The first two are represented as the subdirectories} \filename{C:\\library\\Modelica} \emph{and}
\filename{C:\\lib1\\MyLib}\emph{, whereas the third is stored
as the file} \filename{C:\\lib2\\ComplexNumbers.mo}\emph{.}
...
\emph{in the second directory} \filename{C:\\lib1}
