...
It also follows that an element which is a class can neither be mapped to a file nor a directory; it must be directly present in the same file as its parent class.
