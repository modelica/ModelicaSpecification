...
Coherent SI units are SI base units and coherent derived units.
Coherent indicate that they are without any scaling (e.g., including newton meter, but excluding centimeter), and ensures that the equations between the numerical values of quantities take exactly the same form as the equations between the quantities themselves.
