...
A coherent system of units ensures that the equations between the numerical values of quantities take exactly the same form as the equations between the quantities themselves.

For example, the \firstuse[---]{set of coherent SI units} form a coherent unit system within the SI unit system, and a unit is said to be coherent if it belongs to this set.
