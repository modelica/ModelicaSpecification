...
the state machine since the active state or the enclosing state (in a hierarchical state machine) was last entered.
...
since the active state or the enclosing state (in a hierarchical state machine) was last entered.
