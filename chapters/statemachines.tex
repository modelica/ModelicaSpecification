...
Boolean input \lstinline[basicstyle=\ttfamily]!active!. When this flag is true, the sub-state machine
maintains its previous state, by guarding the equations of the state
variables \lstinline[basicstyle=\ttfamily]!nextState!, \lstinline[basicstyle=\ttfamily]!nextReset! and \lstinline[basicstyle=\ttfamily]!nextResetStates!.
