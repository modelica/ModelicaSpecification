...
\begin{operatordefinition}[transition]\index{transition@\indexinline{transition}}
...
\begin{operatordefinition}[initialState]\index{initialState@\indexinline{initialState}}
\begin{synopsis}\begin{lstlisting}
...
\begin{operatordefinition}[activeState]\index{activeState@\indexinline{activeState}}
\begin{synopsis}\begin{lstlisting}
...
\begin{operatordefinition}[ticksInState]\index{ticksInState@\indexinline{ticksInState}}
\begin{synopsis}\begin{lstlisting}
ticksInState()
\end{lstlisting}\end{synopsis}
\begin{semantics}
...
\begin{operatordefinition}[timeInState]\index{timeInState@\indexinline{timeInState}}
\begin{synopsis}\begin{lstlisting}
timeInState()
\end{lstlisting}\end{synopsis}
\begin{semantics}
