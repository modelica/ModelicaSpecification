...
It supports acausal modeling with mathematical equations and object-oriented constructs to facilitate modeling from first principles and reuse of modeling knowledge.
