...
\item
  ...
  and attributes, such as "\lstinline[basicstyle=\ttfamily]!parameter Real v=5!".
\item
...
\lstinline[basicstyle=\ttfamily]!component-clause! in the Modelica grammar (basically a
...
\lstinline[basicstyle=\ttfamily]!initial! which is a keyword in section headings, and \lstinline[basicstyle=\ttfamily]!der! which is a
keyword for declaration functions, but it is also possible to call the
functions \lstinline[basicstyle=\ttfamily]!initial()! and \lstinline[basicstyle=\ttfamily]!der(...)!.
