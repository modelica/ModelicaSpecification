...
Annotations are defined using the syntactic forms of Modelica record definitions and component declarations, but with special semantics given in \cref{how-to-interpret-annotation-definitions}.
