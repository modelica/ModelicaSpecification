...
In terms of terminology the simulation starts with solving the initialization problem at the starting time, and then simulates forward in time from those computed initial values.
