...
Due to the definition, that only flows where the corresponding \lstinline!min!-attribute is neither zero nor positive enter this formula, a meaningful physical result is always obtained, even in case of zero mass flow rate.
