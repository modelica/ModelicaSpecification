...
keyword \lstinline[basicstyle=\ttfamily]!algorithm! followed by a sequence of statements. Like an
...
element in the sequence of components of an array x is the array element
  with index \lstinline[basicstyle=\ttfamily]!k!, denoted \lstinline[basicstyle=\ttfamily]!x[k]!. All elements of an array have the same
...
\textbf{assignment}: a statement of the form \lstinline[basicstyle=\ttfamily]!x := expr!. The expression
\lstinline[basicstyle=\ttfamily]!expr! must not have higher variability than~x. (See \autoref{simple-assignment-statements}.)

\textbf{attribute}: a component contained in a scalar component, such as
\lstinline[basicstyle=\ttfamily]!min!, \lstinline[basicstyle=\ttfamily]!max!, and \lstinline[basicstyle=\ttfamily]!unit!. All attributes are predefined and attribute values
can only be defined using a modification, such as in \lstinline[basicstyle=\ttfamily]!Real x(unit="kg")!.
Attributes cannot be accessed using dot notation, and are not
constrained by equations and algorithm sections. E.g. in \lstinline[basicstyle=\ttfamily]!Real x(unit="kg") = y;! only the values of \lstinline[basicstyle=\ttfamily]!x! and 
\lstinline[basicstyle=\ttfamily]!y! are declared to be equal,
but not their unit attributes, nor any other attribute of \lstinline[basicstyle=\ttfamily]!x! and \lstinline[basicstyle=\ttfamily]!y!. (See
...
of a local iterator variable). A scope defines a set of visible
  components and classes. Example reference: \lstinline[basicstyle=\ttfamily]!Ele.Resistor.u[21].r! (See
\autoref{component-declarations} and \autoref{slice-operation}.)

\textbf{declaration assignment}: assignment of the form \lstinline[basicstyle=\ttfamily]!x := expression!
...
\textbf{declaration equation}: Equation of the form \lstinline[basicstyle=\ttfamily]!x = expression!
...
modified element. Example: \lstinline[basicstyle=\ttfamily]!vcc(unit="V")=1000!. (See \autoref{modifications}.)
...
element that contains the redeclaration. Example: \lstinline[basicstyle=\ttfamily]!redeclare type Voltage = Real(unit="V")! replaces \lstinline[basicstyle=\ttfamily]!type Voltage!. (See \autoref{redeclaration}.)
...
\lstinline[basicstyle=\ttfamily]!Resistor! (See \autoref{identifiers-names-and-keywords}.)
...
set of visible classes. Example name: "\lstinline[basicstyle=\ttfamily]!Ele.Resistor!". (See \autoref{names}.)
...
\textbf{predefined type}: one of the types \lstinline[basicstyle=\ttfamily]!Real!, \lstinline[basicstyle=\ttfamily]!Boolean!, \lstinline[basicstyle=\ttfamily]!Integer!,
\lstinline[basicstyle=\ttfamily]!String! and types defined as \lstinline[basicstyle=\ttfamily]!enumeration! types. The component
declarations of the predefined types define attributes such as \lstinline[basicstyle=\ttfamily]!min!, \lstinline[basicstyle=\ttfamily]!max!,
and \lstinline[basicstyle=\ttfamily]!unit!. (See \autoref{predefined-types-and-classes}.)

\textbf{prefix}: property of an element of a class definition which can
be present or not be present, e.g. \lstinline[basicstyle=\ttfamily]!final!, \lstinline[basicstyle=\ttfamily]!public!, \lstinline[basicstyle=\ttfamily]!flow!. (See \autoref{prefix-rules}.)

\textbf{primitive type}: one of the built-in types \lstinline[basicstyle=\ttfamily]!RealType!,
\lstinline[basicstyle=\ttfamily]!BooleanType!, \lstinline[basicstyle=\ttfamily]!IntegerType!, \lstinline[basicstyle=\ttfamily]!StringType!, \lstinline[basicstyle=\ttfamily]!EnumType!. The primitive types are
