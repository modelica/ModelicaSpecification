...
\hline
\hline
{\lstinline!+!} & Addition & \cref{addition-subtraction-and-string-concatenation}\\
{\lstinline!-!} & Subtraction & \cref{addition-subtraction-and-string-concatenation}\\
{\lstinline!*!} & Multiplication & \cref{array-element-wise-multiplication} and \cref{matrix-and-vector-multiplication-of-numeric-arrays}\\
{\lstinline!/!} & Division & \cref{division-by-numeric-scalars} and \cref{array-element-wise-division}\\
{\lstinline!^!} & Exponentiation & \cref{element-wise-exponentiation} and \cref{scalar-exponentiation-of-matrices}\\
\hline
\end{tabular}
\end{center}
...
For arrays this explains both the normal operator and the element-wise operators that start with a dot.
