...
The name \lstinline!time! is a keyword, but it corresponds to a built-in variable available in all models and blocks, which is treated as an input variable.
