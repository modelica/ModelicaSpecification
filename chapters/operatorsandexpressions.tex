...
A common -- but not standardized -- approach to solving these systems of equations is to apply a fix point iteration scheme, alternating between solving all the \lstinline!Real! and solving all the other variables.
