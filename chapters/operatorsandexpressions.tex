...
For addition, subtraction, and multiplication two \lstinline!Integer! operands will generate a \lstinline!Integer! result, but see also \cref{evaluation-order}.
\end{nonnormative}
