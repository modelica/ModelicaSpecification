...
integral values it is also allowed to use the `\lstlinline!d!', `\lstlinline!i!', `\lstlinline!o!', `\lstlinline!x!', `\lstlinline!X!', `\lstlinline!u!', and
`\lstlinline!c!' format specifiers (for non-integral values a tool may~round, truncate
...
\emph{If \lstinline!MyLib.Vehicle! is simulated, the call of \lstinline!getInstanceName()!
