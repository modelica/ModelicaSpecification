...
\begin{nonnormative}
The result for division and exponentiation is always of \lstinline!Real! type, see \cref{division-by-numeric-scalars} and \cref{element-wise-exponentiation}.
For addition, subtraction, and multiplication two \lstinline!Integer! operands will generate an \lstinline!Integer! result, but see also \cref{evaluation-order}.
\end{nonnormative}
