...
%TODO-BACK Should column 2 (operator syntax) be formated as code?
\begin{table}[H]
\caption{Operators}
\begin{tabular}{|p{5cm}|p{5cm}|p{4cm}|}
\hline
\emph{Operator Group} & \emph{Operator Syntax} & \emph{Examples}\\ \hline 
postfix array index operator & \lstinline[basicstyle=\ttfamily]![]! & \lstinline[basicstyle=\ttfamily]!arr[index]! \\ \hline
postfix access operator & \lstinline[basicstyle=\ttfamily]!.! & \lstinline[basicstyle=\ttfamily]!a.b! \\ \hline
postfix function call & \emph{funcName}(\emph{function-arguments}) & \lstinline[basicstyle=\ttfamily]!sin(4.36)! \\ \hline
array construct/concat & \begin{tabular}{@{}p{5cm}@{}}\{\emph{expressions}\}\\
{[}\emph{expressions}{]}\\
{[}\emph{expressions}; \emph{expressions}...{]}
\end{tabular} & \lstinline[basicstyle=\ttfamily]!{2,3} [5,6] [2,3; 7,8]! \\ \hline
exponentiation & \ \lstinline[basicstyle=\ttfamily]!^!{} & \lstinline[basicstyle=\ttfamily]!2^3! \\ \hline
multiplicative and array elementwise multiplicative & \lstinline[basicstyle=\ttfamily]!* / .* ./! & \lstinline[basicstyle=\ttfamily]!2*3 2/3 [1,2;3,4].*[2,3;5,6]! \\ \hline
additive and array elementwise additive & + - +\emph{expr} -\emph{expr} .+ .- & \lstinline[basicstyle=\ttfamily]![1,2;3,4].+[2,3;5,6]!\\ \hline
relational & \lstinline[basicstyle=\ttfamily]!< <= > >= == <>! & 
\lstinline[basicstyle=\ttfamily]!a<b, a<=b, a>b, ...!\\ \hline
unary negation & \lstinline[basicstyle=\ttfamily]!not! \emph{expr} & \lstinline[basicstyle=\ttfamily]!not b1! \\ \hline
logical and & \lstinline[basicstyle=\ttfamily]!and! & \lstinline[basicstyle=\ttfamily]!b1 and b2! \\ \hline
logical or & \lstinline[basicstyle=\ttfamily]!or! & \lstinline[basicstyle=\ttfamily]!b1 or b2!\\ \hline
array range & \emph{expr} \lstinline[basicstyle=\ttfamily]!:! \emph{expr}
\emph{expr} \lstinline[basicstyle=\ttfamily]!:! \emph{expr} \lstinline[basicstyle=\ttfamily]!:! \emph{expr} & \lstinline[basicstyle=\ttfamily]!1:5 start:step:stop!\\ \hline
conditional & if \emph{expr} then \emph{expr} else \emph{expr} & \lstinline[basicstyle=\ttfamily]!if b then 3 else x!\\ \hline
named argument & \emph{ident} = \emph{expr} & \lstinline[basicstyle=\ttfamily]!x = 2.26!\\ \hline
\end{tabular}
\end{table}

The conditional operator may also include elseif-clauses. Equality \lstinline[basicstyle=\ttfamily]!=! and
...
\begin{longtable}[]{ll}
\lstinline[basicstyle=\ttfamily]!>! & greater than\\ 
\lstinline[basicstyle=\ttfamily]!>=! & greater than or equal\\ 
\lstinline[basicstyle=\ttfamily]!<! & less than\\
\lstinline[basicstyle=\ttfamily]!<=! & less than or equal to\\ 
\lstinline[basicstyle=\ttfamily]!==! & equality within expressions\\ 
\lstinline[basicstyle=\ttfamily]!<>! & Inequality\\ 
\end{longtable}
...
\begin{longtable}[]{ll}
\lstinline[basicstyle=\ttfamily]!not! & negation, unary operator\\ 
\lstinline[basicstyle=\ttfamily]!and! & logical and\\ 
\lstinline[basicstyle=\ttfamily]!or! & logical or\\ 
\end{longtable}
...
\lstinline[basicstyle=\ttfamily]!sign(v)! & Is expanded into ``\lstinline[basicstyle=\ttfamily]!noEvent(if v>0 then 1 else if v<0 then -1 else 0)!''. Argument v needs to be an Integer or Real
expression.\\ \hline
...
\lstinline[basicstyle=\ttfamily]!Integer(e)! & Returns the ordinal number of the expression \lstinline[basicstyle=\ttfamily]!e! of
enumeration type that evaluates to the enumeration value \lstinline[basicstyle=\ttfamily]!E.enumvalue!,
where \lstinline[basicstyle=\ttfamily]!Integer(E.e1)=1!, \lstinline[basicstyle=\ttfamily]!Integer(E.en)=n!, for an enumeration type
...
For any enumeration type \lstinline[basicstyle=\ttfamily]!EnumTypeName!, returns the enumeration
value \lstinline[basicstyle=\ttfamily]!EnumTypeName!.e such that \lstinline[basicstyle=\ttfamily]!Integer(EnumTypeName.e) = i!. Refer to the definition of 
\lstinline[basicstyle=\ttfamily]!Integer! above.
...
%TODO-BACK: Treat indent for multi-line argument lists
...
%TODO-BACK Should the right column also be formatted as code? e.g. atan2()?
...
Inside an if-expression, \lstinline[basicstyle=\ttfamily]!if!-clause, \lstinline[basicstyle=\ttfamily]!while!-statement or \lstinline[basicstyle=\ttfamily]!for!-clause, that
