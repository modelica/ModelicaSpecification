...
\item
  Expressions in functions (unless they have annotation \lstinline!GenerateEvents = true!, \Cref{modelica:GenerateEvents}), behave as though they were discrete-time expressions.
\end{itemize}
