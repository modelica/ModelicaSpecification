...
\hline
\hline
{\lstinline!+!} & Addition, see \cref{addition-subtraction-and-string-concatenation}\\
{\lstinline!-!} & Subtraction, see \cref{addition-subtraction-and-string-concatenation}\\
{\lstinline!*!} & Multiplication, see \cref{array-element-wise-multiplication} and \cref{matrix-and-vector-multiplication-of-numeric-arrays}\\
{\lstinline!/!} & Division, see \cref{division-by-numeric-scalars}\\
{\lstinline!^!} & Exponentiation, see \cref{element-wise-exponentiation} and \cref{scalar-exponentiation-of-matrices}\\
\hline
\end{tabular}
\end{center}
