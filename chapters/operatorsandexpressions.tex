...
\lstinline!rem(3,1.4)=0.2\emph{,} rem(-3,1.4)=-0.2!{]}\\ \hline
...
\lstinline!atan2(y, x)! & the atan2($y$,$x$) function calculates the principal value of the arc tangent of \emph{y/x}, using the signs of the two arguments to determine the quadrant of the result\\ \hline
