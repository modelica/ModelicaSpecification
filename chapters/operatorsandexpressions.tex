...
\item
  In relations of the form \lstinline!v1 == v2 or v1 <> v2!, \lstinline!v1! or \lstinline!v2! shall, unless used in a function without \lstinline!GenerateEvents = true! (see \cref{modelica:GenerateEvents}), not be a subtype of \lstinline!Real!.
  \begin{nonnormative}
  ...
  The handling in normal functions is similar to the handling in external functions.
  Functions with \lstinline!GenerateEvents = true! can be treated as being directly inlined, and thus follow the rules for non-functions.
  \end{nonnormative}
\item
