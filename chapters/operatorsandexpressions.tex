...
\item
  ...
  \end{nonnormative}
\item
  Unless inside \lstinline!noEvent!: Function calls where the function has annotation \lstinline!GenerateEvents = true!, \Cref{modelica:GenerateEvents} if no formal output contains a subtype of \lstinline!Real!.
