...
None that the operators defined in this chapter vectorize, but some can pass through an array of clocked expressions (but not of clocks) in a similar way.
