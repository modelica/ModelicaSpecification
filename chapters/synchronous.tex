...
\begin{nonnormative}
In order to handle measurement it is necessary to consistently update the discretized states, see \textcite{OlssonEtAl2017ModelBased}.
This replaces the previous discretization methods for specific variables.
Note that \lstinline!reinit! also has another definiton, see \cref{reinit}.
\end{nonnormative}
