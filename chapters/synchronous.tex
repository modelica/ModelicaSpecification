...
The benefits of synchronous behavior is that it allows model to define large
...
\begin{enumerate}
\item
  Possibility to detect inconsistent sampling rate, since clock partitioning, \cref{clock-partitioning},
...
\item
  ...
  require several evaluations of the model (in some cases tools
...
\item
  ...
  For standard when-clauses one either need a separate sampled math-block for each operation, or
