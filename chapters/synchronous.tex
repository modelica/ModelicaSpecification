...
\end{lstlisting}
\emph{The value of} \lstinline[basicstyle=\ttfamily]!yc! \emph{at the first clock tick is} \lstinline[basicstyle=\ttfamily]!yc=2! \emph{(and not} \lstinline[basicstyle=\ttfamily]!yc=1! \emph{).
The reason is that the continuous-time model} \lstinline[basicstyle=\ttfamily]!der(y)+y=2! \emph{ is first
initialized and after initialization} \lstinline[basicstyle=\ttfamily]!y! \emph{has the value} \lstinline[basicstyle=\ttfamily]!2!\emph{. At the first
clock tick at time=0, the left limit of} \lstinline[basicstyle=\ttfamily]!y! \emph{is} \lstinline[basicstyle=\ttfamily]!2! \emph{and therefore} \lstinline[basicstyle=\ttfamily]!yc = 2!.
...
\emph{Then when} \lstinline[basicstyle=\ttfamily]!ys! \emph{exists, also} \lstinline[basicstyle=\ttfamily]!yb! \emph{exists and} \lstinline[basicstyle=\ttfamily]!ys = yb!\emph{.\\
The variable} \lstinline[basicstyle=\ttfamily]!yb! \emph{exists for the above parameterization with} \lstinline[basicstyle=\ttfamily]!a<b! \emph{one clock tick before} \lstinline[basicstyle=\ttfamily]!ys!\emph{. Therefore, }
\lstinline[basicstyle=\ttfamily]!backSample! \emph{is basically
a} \lstinline[basicstyle=\ttfamily]!shiftSample! \emph{with a different parameterization and the clock
of} \lstinline[basicstyle=\ttfamily]!backSample.y! \emph{ticks before the clock of} \lstinline[basicstyle=\ttfamily]!u!\emph{. Before the clock
of} \lstinline[basicstyle=\ttfamily]!u! \emph{ticks, }\lstinline[basicstyle=\ttfamily]!yb = u.start!\emph{.}
...
If the solver method is \textbf{not} \lstinline[basicstyle=\ttfamily]!"External"!, then the partition is
