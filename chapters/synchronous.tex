...
\begin{operatordefinition*}[Clock]\label{modelica:clock-inferred}\index{Clock@\indexinline{Clock}!inferred}
...
\begin{operatordefinition*}[Clock]\label{modelica:clock-rational}\index{Clock@\indexinline{Clock}!rational}
\begin{synopsis}\begin{lstlisting}
...
\begin{operatordefinition*}[Clock]\label{modelica:clock-interval}\index{Clock@\indexinline{Clock}!interval}
\begin{synopsis}\begin{lstlisting}
...
\begin{operatordefinition*}[Clock]\label{modelica:clock-event}\index{Clock@\indexinline{Clock}!event}
\begin{synopsis}\begin{lstlisting}
...
\begin{operatordefinition*}[Clock]\label{modelica:clock-solver}\index{Clock@\indexinline{Clock}!solver}
\begin{synopsis}\begin{lstlisting}
...
\begin{operatordefinition*}[sample]\label{modelica:clocked-sample}\index{sample@\indexinline{sample}!clocked}
\begin{synopsis}\begin{lstlisting}
