...
\item
  2\emph{+}\lstinline!nXi! \emph{(}\lstinline!p!\emph{,} \lstinline!h!\emph{,} 
...
\item
  2\emph{+}nXi \emph{flow variables in the} \lstinline!port! \emph{connector. }
\end{itemize}
...
\item
  4+2\emph{*}nXi \emph{(inside the} port \emph{connector), plus}
\item
  2+nXi \emph{(the input variables in the connectors of the} \lstinline!medium!
  \emph{model)}
\end{itemize}
