...
has special semantics, see \autoref{functional-input-arguments-to-functions}), and the input prefix is not
...
prefixes input and output - see \autoref{external-objects}.
...
parameter and constant are described in \autoref{variability-of-structured-entities} for structured
components.
...
\item
  ...
  diagram semantics, see \autoref{connect-equations-and-connectors} (e.g., a connector with an output
