...
%TODO-BACK Check left side of the table! -> yes, format as code
...
\textbf{model} & Identical to \lstinline[basicstyle=\ttfamily]!class!, the basic class concept, i.e., no
restrictions and no enhancements.\\ \hline
\textbf{block} & Same as \lstinline[basicstyle=\ttfamily]!model! with the restriction that each connector
...
\textbf{function} & See \autoref{function-as-a-specialized-class} for restrictions
