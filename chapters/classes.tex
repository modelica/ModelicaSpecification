...
There are no continuous-time \lstinline!Boolean!, \lstinline!Integer! \emph{or} \lstinline!String!
...
A model or block class is \firstuse{locally balanced} if the \firstuse{local number of
unknowns} is identical to the \firstuse{local equation size} for all legal
...
% The sentence above looks strange.  Shouldn't it be "globally singular"?
