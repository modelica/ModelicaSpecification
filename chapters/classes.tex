...
Members of a Modelica class can have two levels of visibility: \lstinline!public!\index{public@\robustinline{public}} or \lstinline!protected!\index{protected@\robustinline{protected}}.
...
A class defined with \lstinline!partial!\index{partial@\robustinline{partial}} in the \lstinline[language=grammar]!class-prefixes! is called a \firstuse{partial} class.
...
The prefixes \lstinline!input!\index{input@\robustinline{input}} and \lstinline!output!\index{output@\robustinline{output}} have a slightly different semantic meaning depending on the context where they are used:
\begin{itemize}
\item
...
\begin{itemize}
\item
  A variable \lstinline!vc! declared with \lstinline!constant!\index{constant@\robustinline{constant}} prefix remains constant during transient analysis, with a value that is unaffected by the initialization problem.
\item
  A variable \lstinline!vc! declared with the \lstinline!parameter!\index{parameter@\robustinline{parameter}} prefix remains constant during transient analysis, with a value determined by the initialization problem.
\item
...
If a \lstinline!Real! variable is declared with the prefix \lstinline!discrete!\index{discrete@\robustinline{discrete}} it must in a simulation model be assigned in a when-clause, either by an assignment or an equation.
...
\begin{itemize}
\item \lstinline!record!\index{record@\robustinline{record}} --
...
\item \lstinline!type!\index{type@\robustinline{type}} --
May only be predefined types, enumerations, array of type, or classes extending from type.

\item \lstinline!model!\index{model@\robustinline{model}} --
The normal modeling class in Modelica.

\item \lstinline!block!\index{block@\robustinline{block}} --
...
\item \lstinline!function!\index{function@\robustinline{function}} --
...
\item \lstinline!connector!\index{connector@\robustinline{connector}} --
...
\item \lstinline!package!\index{package@\robustinline{package}} --
...
\item \lstinline!operator record!\index{operator record@\robustinline{operator record}} --
...
\item \lstinline!operator!\index{operator@\robustinline{operator}} --
...
\item \lstinline!operator function!\index{operator function@\robustinline{operator function}} --
...
A declaration of the form\index{enumeration@\robustinline{enumeration}}
\begin{lstlisting}[language=modelica]
...
The predefined \lstinline!StateSelect!\index{StateSelect@\robustinline{StateSelect}} enumeration type is the type of the \lstinline!stateSelect! attribute of the \lstinline!Real! type.  It is used to explicitly control state selection.
...
The predefined \lstinline!AssertionLevel!\index{AssertionLevel@\robustinline{AssertionLevel}} enumeration type is used together with \lstinline!assert!, \cref{assert}.
\begin{lstlisting}[language=modelica]
...
The package \lstinline!Connections!\index{Connections@\robustinline{Connections}} is used for over-constrained connection graphs, \cref{equation-operators-for-overconstrained-connection-based-equation-systems}.
